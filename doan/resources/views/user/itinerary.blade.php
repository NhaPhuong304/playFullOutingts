            ...
            <div class="mt-8 flex flex-col gap-4">
                <div class="flex flex-col md:flex-row gap-4 items-center">
                    ...
                    <div class="w-full md:w-1/2 lg:w-2/3">
                        <label class="flex flex-col min-w-40 h-12 w-full">
                            <div class="flex w-full items-stretch rounded-lg h-full">
                                <div class="text-primary flex items-center justify-center pl-4 bg-white dark:bg-charcoal rounded-l-lg">
                                    <span class="material-symbols-outlined">search</span>
                                </div>

                                <input id="searchInputBox"
                                    class="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg
                                        text-charcoal dark:text-off-white focus:outline-0 focus:ring-2 focus:ring-primary/50
                                        bg-white dark:bg-charcoal h-full placeholder:text-charcoal/60 px-4 rounded-l-none"
                    ...
                    <div class="w-full md:w-auto">
                        <select id="daySelect"
                            class="h-12 px-4 w-36 rounded-lg bg-white dark:bg-charcoal border border-gray-300 
               dark:border-gray-700 text-charcoal dark:text-off-white text-sm">
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    <!-- Nút ALL -->
                    <div class="category-filter active-category flex h-8 cursor-pointer items-center rounded-full px-4 
                bg-primary/20 text-primary dark:bg-primary/30"
                    ...
                    <div class="category-filter flex h-8 cursor-pointer items-center rounded-full px-4 
                    bg-white dark:bg-charcoal"
                        data-cat="{{ strtolower($cat->name) }}">
                        <p class="text-charcoal dark:text-off-white text-sm font-medium">
                            {{ $cat->name }}
                        </p>
                    </div>
                    @endforeach
